		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					float revenueFloat = Float.parseFloat(revenueField.getText());
					new ResultFrame(MainFrame.this, revenueFloat);
				} catch (NumberFormatException e2) {
					JOptionPane.showMessageDialog(MainFrame.this, "Por Favor digite apenas números!");
				}
			}
		});
